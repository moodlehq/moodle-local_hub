...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="/error500/styles.css" />
</head>
<body>
    <div id="header">
        <div id="header-logo">
            <a id="logo" href="/secure/Dashboard.jspa">
                <img class="logo" src="/error500/images/moodle-logo.gif" width="100" height="23" border="0" alt="Moodle Tracker">
            </a>
        </div>
        <!-- moodle menu start -->
        <div id="moodle-menu"> 
    ...
    <div id="moodlesitelink">
        ...
        <a href="http://moodle.org/" class="moodle-logo-link">
            <img width="100" height="30" src="/error500/images/moodle-logo-footer.gif" border="0" alt="moodlelogo" title="Return to Moodle.org" />
        </a>
    </div>
</body>
