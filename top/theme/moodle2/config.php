<?PHP // $Id: config.php,v 1.3 2006/04/10 17:38:23 urs_hunkler Exp $
...
$CFG->CSSEdit = false;   // Keep false for production speed

$THEME->sheets = array('reset', 'geshi', 'moodle2', 'moodlemenu', 'moodle.org');
...
$THEME->block_l_min_width = 220;
$THEME->block_l_max_width = 220;
$THEME->block_r_min_width = 220;
$THEME->block_r_max_width = 220;
