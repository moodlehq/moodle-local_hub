...
$string['additionalcoursedesc'] = 'License: {$a->license} - Language: {$a->lang} - Creator: {$a->creatorname} - Publisher: {$a->publishername} - Subject: {$a->subject}
...
$string['coursesettingsupdated'] = '{$a} settings have been updated.';
...
$string['privacy_help'] = 'You can choose how visible your hub will be on the hub directory.  A private hub will not be listed anywhere on the hub directory, however sites can still register if they know your URL and the (optional) password. Only registered sites can search on a private hub.';
