...
$string['confirmbulkdelete'] = 'Bulk detele confirmation';
$string['confirmbulkvisible'] = 'Bulk visible confirmation';
$string['confirmbulknotvisible'] = 'Bulk not visible confirmation';
$string['confirmmessagebulkdelete'] = 'Are you sure to delete the following courses:';
$string['confirmmessagebulkvisible'] = 'Are you sure to make visible the following courses:';
$string['confirmmessagebulknotvisible'] = 'Are you sure to make not visible the following courses:';
$string['confirmregistration'] = 'Confirm registration';
$string['confirmforceunregistration'] = 'Any existing information will not be modified on the hub directory. Are you sure to force unregistration?';
$string['confirmunregistration'] = 'Are you sure to unregister from the hub directory?';
$string['contactemail'] = 'Contact email';
$string['contactemail_help'] = 'The contact email that the hub directory administrator will use to contact the hub administrator for any important issues.';
$string['contactname'] = 'Contact name';
$string['contactname_help'] = 'The hub administrator that the hub directory administrator will try to contact for any important issues.';
...
$string['hubimage_help'] = 'This image is saved on your hub disk. Once your hub is registered, the hub directory will try to access to this image by HTTP in order to cache it. If the hub directory cannot access to this image, no image will be displayed on the listing.';
...
$string['hub:registercourse'] = 'Register/Update a course to the hub.';
...
$string['privacy_help'] = 'Your hub can be private, public and added to global search. A private hub will not be listed anywhere on the hub directory. It is however still possible knowing your hub address to register. If you want to protect registration enter a password.';
