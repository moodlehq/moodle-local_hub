<?php
// This file is part of Moodle site - http://moodle.org/
//
...
/**
 * Strings for component 'local_moodleorg', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    local
...
$string['donationstrust'] = 'Moodle has a development fund run by the Moodle Trust which contracts programmers to work on Moodle, and also supports expenses like moodle.org.';
...
$string['focusbox_community'] = 'Community discussions';
$string['focusbox_community_text'] = 'Join the conversation and share solutions and ideas with Moodlers worldwide.';
$string['focusbox_community_viewall'] = 'List all communities';
...
$string['heroslide_community_link1'] = 'Statistics';
$string['heroslide_community_link2'] = 'Join us';
$string['heroslide_community_slidecontrol'] = 'Driven by a global community';
...
$string['heroslide_power_link1'] = 'Features';
$string['heroslide_power_link2'] = 'Demo';
$string['heroslide_power_slidecontrol'] = 'Full-featured, open source learning platform';
$string['heroslide_global_headline'] = 'Powering learning environments worldwide';
$string['heroslide_global_description'] = 'Available in more than 95 languages, Moodle is trusted by organisations and institutions large and small with millions of users all over the world.';
$string['heroslide_global_link1'] = 'See list';
$string['heroslide_global_link2'] = '';
$string['heroslide_global_slidecontrol'] = 'Powering learning environments worldwide';
$string['heroslide_story_headline'] = 'Improving teaching and learning everywhere';
...
$string['heroslide_story_link1'] = 'Read more';
$string['heroslide_story_link2'] = '';
...
$string['socialinfo'] = 'We are on several social media sites to help us raise awareness of the Moodle project as well as share the latest news and happenings in the Moodle world. Follow us on our social media pages to stay up to date with all things Moodle, and meet others in the community!';
...
$string['social-twitter-moodlehq'] = 'A window into what\'s happening at MoodleHQ';
$string['social-twitter-moodlejobs'] = 'Aggregated Moodle jobs globally';
$string['social-twitter-moodlenet'] = 'Aggregated directory of shared Moodle courses and content';
$string['social-twitter-moodleplugins'] = 'Aggregated directory of Moodle modules and plugins';
...
$string['social-twitter-moodlesecurity'] = 'Moodle security announcements and updates';
$string['social-twitter-moodlesites'] = 'Site status updates and planned maintenance times of all Moodle sites (Moodle.org, Docs, Downloads, Demo, Tracker, Development, Translation, Moodle.net, Moodle.com)';
$string['social-twitter-moodlethemes'] = 'Aggregated directory of Moodle themes';
...
$string['usingmoodle'] = 'Using Moodle';
