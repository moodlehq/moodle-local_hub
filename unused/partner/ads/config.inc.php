...
// Database username
$phpAds_config['dbuser'] = 'moodorg_moodle';

// Database password
$phpAds_config['dbpassword'] = 'moodledbpass';

// Database name
$phpAds_config['dbname'] = 'moodorg_ads';
...
$phpAds_config['url_prefix'] = 'http://moodle.org/partner/ads';
...
$phpAds_config['reverse_lookup'] = true;

// Find the correct IP for users behind a proxy
$phpAds_config['proxy_lookup'] = true;
...
$phpAds_config['geotracking_location'] = '/home/moodorg/public_html/partner/ads/GeoIP.dat';
...
$phpAds_config['geotracking_cookie'] = true;
